...
class DriveCommandBridge(Node):
    ...
    def __init__(self) -> None:
        ...
        outer_ratio = self.declare_parameter('outer_ratio', 0.25).get_parameter_value().double_value
        motor_2_sign = self.declare_parameter('motor_2_sign', -1.0).get_parameter_value().double_value
        ...
        self._motor_2_sign = motor_2_sign
        ...
        self.get_logger().info(
            f'drive_command_bridge listening on {input_topic} and publishing to '
            f'{controller_topic} (outer_ratio={outer_ratio:.3f}, motor_2_sign={motor_2_sign:.3f})'
        )
    ...
    def _on_velocity_command(self, msg: Float64) -> None:
        ...
        out_msg.data = [
            command,
            self._motor_2_sign * command,
            self._outer_ratio * command,
        ]
